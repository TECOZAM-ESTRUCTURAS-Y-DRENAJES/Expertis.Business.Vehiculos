...
Public Class TipoVehiculo
    ...
    Private Const cnEntidad As String = "tbVehiculoTipo"
    ...
    <Task()> Public Shared Sub AsignarValoresPredeterminados(ByVal data As DataRow, ByVal services As ServiceProvider)
        ...
        'dt = AdminData.GetData("SELECT MAX(IDTipo) FROM tbVehiculoTipo")

        'data("idTipo") = dt(0)(0) + 1
        data("idTipo") = AdminData.GetAutoNumeric
